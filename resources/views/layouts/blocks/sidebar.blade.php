    ...
    <nav id="sidebar">
            ...
            <div class="nav-logo">
                ...
                <div class="nav-item theme-text">
                    <a href="/" class="nav-link"> 
                        {{ Auth::user()->role === 'admin' ? 'ADMIN' : 'GUIDE' }} 
                    </a>
                </div>
            </div>
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            @if(Auth::check() && Auth::user()->role === 'admin')
                ...
                <li class="menu">
                    <a href="#tours" data-bs-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                        <div>
                    ...
                    <ul class="collapse submenu list-unstyled" id="tours" data-bs-parent="#accordionExample">
                        <li>
                ...
                <li class="menu">
                    <a href="#bookings" data-bs-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                        <div>
                    ...
                    <ul class="collapse submenu list-unstyled" id="bookings" data-bs-parent="#accordionExample">
                        <li>
                            <a href="#"> Danh sách Đặt chỗ </a>
                        </li>
                    </ul>
                </li>
