            ...
            <form action="{{ route('tours.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="name" class="form-control" required placeholder="VD: Tour Sapa 3N2Đ...">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Điểm đến</label>
                        <input type="text" name="destination" class="form-control" required placeholder="VD: Sapa, Đà Lạt...">
                    </div>
                </div>
