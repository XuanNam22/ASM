            ...
            <form action="{{ route('tours.update', $tour->id) }}" method="POST">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" name="price" class="form-control" value="{{ round($tour->price) }}" required min="0">
                    </div>
                </div>
                ...
                <div class="row mb-4">
                    <div class="col-md-6">
                        ...
                        <select name="guide_id" class="form-select">
                            ...
                            @foreach($guides as $guide)
                                <option value="{{ $guide->id }}" {{ $tour->guide_id == $guide->id ? 'selected' : '' }}>
                                    {{ $guide->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="status" class="form-select">
                            ...
                            <option value="closed" {{ $tour->status == 'closed' ? 'selected' : '' }}>Đã kết thúc</option>
                        </select>
                    </div>
                </div>
